...
if Rails.env.development?
	...
	Account.create(source_id: event1.id, source_type: 'Event', event_id: event1.id, account_name: 'Test Event #1')
	Account.create(source_id: user1.id, source_type: 'User', event_id: event1.id, account_name: 'User One')
	Account.create(source_id: user2.id, source_type: 'User', event_id: event1.id, account_name: 'User Two')
	Account.create(source_id: user3.id, source_type: 'User', event_id: event1.id, account_name: 'User Three')
end